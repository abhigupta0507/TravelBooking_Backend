...
public class Vendor extends User {
    ...
    public void setVendor_name(String vendor_name) { this.vendor_name = vendor_name; }
    ...
    public java.math.BigDecimal getAmt_due() { return amt_due; }
    public void setAmt_due(java.math.BigDecimal amt_due) { this.amt_due = amt_due; }
