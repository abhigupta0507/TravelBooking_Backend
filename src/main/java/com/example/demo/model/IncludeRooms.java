...
public class IncludeRooms {
    ...
    public Integer getCheck_out_day() { return check_out_day; }
    public void setCheck_out_day(Integer check_out_day) { this.check_out_day = check_out_day; }

    public Integer getCheck_in_day() { return check_in_day; }
    public void setCheck_in_day(Integer check_in_day) { this.check_in_day = check_in_day; }
